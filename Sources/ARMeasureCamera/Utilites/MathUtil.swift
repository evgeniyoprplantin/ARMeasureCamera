...
public func thetaRadians(_ vector1: simd_float3, _ vector2: simd_float3) -> Float {
...
public func projection(of vector: simd_float3, using planeNormalVector: simd_float3) -> simd_float3 {
...
public func angle(between vector1: simd_float3, and vector2: simd_float3, along vector3: simd_float3) -> Float {
...
public func oppositeVector(hypotenuseVector: simd_float3, adjacentUnitVector: simd_float3) -> simd_float3 {
